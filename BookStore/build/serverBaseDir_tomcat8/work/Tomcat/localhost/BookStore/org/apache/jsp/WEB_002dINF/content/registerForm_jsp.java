 ...
 * Generated at: 2017-07-24 12:00:00 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t<form>\r\n");
      out.write("\t\t\t<input type=\"text\" id=\"loginname\" name=\"loginname\" value=\"loginname\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'loginname';}\" >\r\n");
      out.write("\t\t\t<input type=\"password\" id=\"password\" name=\"password\" value=\"password\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'password';}\" >\r\n");
      out.write("\t        <input type=\"text\" id=\"username\" name=\"username\" value=\"username\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'username';}\" >\r\n");
      out.write("\t        <input type=\"text\" id=\"phone\" name=\"phone\" value=\"phone\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'phone';}\" >\r\n");
      out.write("\t        <input type=\"text\" id=\"address\" name=\"address\" value=\"address\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'address';}\" >\r\n");
      out.write("\t        <input type=\"text\" id=\"mail\" name=\"mail\" value=\"mail\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'mail';}\" >\r\n");
      out.write("\t    </form>\r\n");
